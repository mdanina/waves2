...
const scaleConfigs: ScaleDisplayConfig[] = [
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Мы поможем подобрать подходящего специалиста, который разберется в ситуации и предложит план поддержки.',
      ...
      borderline: [
        ...
        '<strong>Наблюдайте за динамикой.</strong> Если вы заметите ухудшение состояния, запишитесь на бесплатную консультацию в Балансити — мы поможем подобрать специалиста.',
      ],
      typical: [
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> При значительных поведенческих трудностях важно понять их причину. Мы поможем подобрать специалиста, который разберется в ситуации.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Для точной оценки ситуации важно пройти диагностику у специалиста. Мы поможем подобрать подходящего.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Мы поможем подобрать специалиста, который оценит сенсорные особенности ребенка и разработает программу поддержки.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Мы поможем подобрать специалиста, который оценит речевое развитие и при необходимости составит программу поддержки.',
      ...
      borderline: [
        ...
        '<strong>При сомнениях — консультация.</strong> Даже при небольших трудностях специалист может дать полезные рекомендации. Запишитесь на бесплатную консультацию в Балансити.',
      ],
      typical: [
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Мы поможем подобрать специалиста, который разберется в ситуации и предложит программу развития социальных навыков.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Специалист поможет ребенку сформировать более позитивное отношение к себе.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Мы поможем подобрать специалиста, который выявит конкретные трудности и составит план поддержки.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Низкая мотивация может быть симптомом эмоциональных проблем — важно разобраться в причинах со специалистом.',
  ...
  },
  {
    ...
    recommendations: {
      concerning: [
        '<strong>Запишитесь на бесплатную консультацию в Балансити.</strong> Мы поможем подобрать специалиста, который работает с травмой и поможет ребенку переработать опыт.',
      ...
      borderline: [
        ...
        '<strong>Наблюдайте за изменениями.</strong> Если симптомы усиливаются — запишитесь на консультацию в Балансити.',
