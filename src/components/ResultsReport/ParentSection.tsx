                      ...
                      <CollapsibleContent className="mt-2 rounded-lg bg-white border border-border p-4">
                        {parentResults.anxiety.status === 'concerning' ? (
                          <ul className="list-inside space-y-3 text-foreground">
                            <li>
                              <strong>Обратитесь к специалисту.</strong> При значительном уровне тревожности рекомендуется консультация психолога или психотерапевта. В Waves мы можем помочь подобрать подходящего специалиста.
                            </li>
                            <li>
                    ...
                    <Collapsible open={openSections['parent-depression-do']} onOpenChange={() => toggleSection('parent-depression-do')}>
                      ...
                      <CollapsibleContent className="mt-2 rounded-lg bg-white border border-border p-4">
                        {parentResults.depression.status === 'concerning' ? (
                          <ul className="list-inside space-y-3 text-foreground">
                            <li>
                              <strong>Обратитесь к специалисту.</strong> При значительных депрессивных симптомах важно получить профессиональную помощь. В Waves мы можем помочь подобрать подходящего специалиста.
                            </li>
                            <li>
