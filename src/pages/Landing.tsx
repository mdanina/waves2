...
export default function Landing() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Опытные специалисты под руководством всемирно известных экспертов в области детского и семейного благополучия. Все специалисты являются сотрудниками Balansity."
    },
    {
      icon: Video,
    ...
    },
    {
      icon: FileText,
      title: "Прозрачность",
      description: "Отчеты на основе результатов и прогресс, который вы можете видеть. Доступ к заметкам специалистов и результатам оценки в приложении Balansity."
    },
    {
      icon: CheckCircle2,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Если вы хотите пообщаться с профильным специалистом и начать работу, пожалуйста, запишитесь на бесплатную вводную сессию через ваш аккаунт Balansity. Бесплатная сессия открывается после прохождения чекапа."
    }
  ];
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm md:text-base text-muted-foreground">
                          Персонализированные планы, результаты оценки, отчеты о прогрессе и заметки специалистов. Все в личном кабинете Balansity.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="pr-4 pl-8 md:pr-0 md:pl-16 lg:pl-24">
                  ...
                  <div className="space-y-4 mb-6">
                    <p className="text-base text-foreground/90">
                      Наталья Владимировна Кисельникова — ведущий методолог Balansity, кандидат психологических наук, психолог-исследователь с более чем 15-летним опытом руководства междисциплинарными проектами в сфере семейного благополучия.
                    </p>
                    <p className="text-base text-foreground/90">
                    ...
                    <p className="text-base text-foreground/90">
                      В Balansity Наталья отвечает за стратегическую архитектуру продукта, включая модель оценки семейного благополучия, маршрутизацию поддержки и интеграцию научно обоснованных подходов в масштабируемую цифровую платформу.
                    </p>
                  </div>
                </div>
