        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80">
              ООО «Waves» (далее — «Компания», «мы») серьезно относится к защите персональных данных пользователей платформы Waves. Настоящая Политика конфиденциальности описывает, какие данные мы собираем, как их используем и защищаем.
            </p>
          </section>
