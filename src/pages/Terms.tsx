        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80">
              Настоящие Условия использования (далее — «Условия») регулируют отношения между ООО «Waves» (далее — «Компания», «мы», «нас») и пользователями платформы Waves (далее — «Сервис», «Платформа»).
            </p>
            <p className="text-foreground/80">
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80">
              Waves — это платформа для оценки ментального здоровья детей и их семей. Сервис предоставляет:
            </p>
